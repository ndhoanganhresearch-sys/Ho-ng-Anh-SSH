...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      // v7: removed "systematically overestimate" absolute; hedged with "can overestimate"
      body([
      ...
      // --- P6: Proposed system — v7: "standards-informed"; RAG = "drafts preliminary summaries"; no "guarantee" ---
      body([
      ...
      // --- P7: 3 contributions — v7: "reduces" not "eliminates"; "ensures" not "guarantees" ---
...
Packer.toBuffer(doc).then(buffer => {
  const out = "C:\\Users\\ssl\\Desktop\\3 tháng viết báo\\draf\\Intro_SSL_Tunnel_v7.docx";
